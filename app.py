...
def generate_dataset(nbr):
    ...
    face_classifier = cv2.CascadeClassifier(
        "/Users/nhathuy/PycharmProjects/FlaskOpencv_FaceRecognition/resources/haarcascade_frontalface_default.xml")
    ...
    while True:
        ...
        if face_cropped(img) is not None:
            ...
            file_name_path = ("/Users/nhathuy/PycharmProjects/FlaskOpencv_FaceRecognition/dataset/" + nbr + "." + str(img_id) + ".jpg" )
...
def train_classifier(prs):

    dataset_dir ="/Users/nhathuy/PycharmProjects/FlaskOpencv_FaceRecognition/dataset"
    ...
    clf.train(faces, ids)
    clf.write("/Users/nhathuy/PycharmProjects/FlaskOpencv_FaceRecognition/classifier.xml")
...
def face_recognition():  # generate frame by frame from camera
    ...
    faceCascade = cv2.CascadeClassifier("/Users/nhathuy/PycharmProjects/FlaskOpencv_FaceRecognition/resources/haarcascade_frontalface_default.xml")
    clf = cv2.face.LBPHFaceRecognizer_create()
...
@app.route('/train_test/<prs>')
def train_test(prs):
    return Response(train_classifier(prs))

@app.route('/train_test_01/<nbr>')
def train_dataset_01(nbr):
    # Video streaming route. Put this in the src attribute of an img tag
    return render_template('train.html', nbr=nbr)
